...
namespace G8_Planet
{
    partial class frm_planet
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btn_genArch = new System.Windows.Forms.Button();
			...
			this.panel1.Controls.Add(this.btn_genArch);
			...
			// btn_genArch
			// 
			this.btn_genArch.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(215)))), ((int)(((byte)(173)))), ((int)(((byte)(235)))));
			this.btn_genArch.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.btn_genArch.Location = new System.Drawing.Point(516, 212);
			this.btn_genArch.Margin = new System.Windows.Forms.Padding(2);
			this.btn_genArch.Name = "btn_genArch";
			this.btn_genArch.Size = new System.Drawing.Size(151, 23);
			this.btn_genArch.TabIndex = 2;
			this.btn_genArch.Text = "Generar Archivos";
			this.btn_genArch.UseVisualStyleBackColor = false;
			this.btn_genArch.Click += new System.EventHandler(this.btn_genArch_Click);
			// 
			// frm_planet
			// 
